          ...
          <Button
            ...
            onClick={(e) => {
              ...
              if (weatherInput.trim() !== "") {
                formHandler.handleWeatherForm(e, weatherInput.trim());
                setWeatherInput("");
    ...
    <React.Fragment>
      ...
      >
        <section className="app-header d-flex justify-content-between px-2 flex-row-reverse ">
          ...
          <Link to="/" id="weatherDashboardIcon">
            <svg
            ...
            >
              ...
              <path
                fill="lightskyblue"
                d="M4 13h6c.55 0 1-.45 1-1V4c0-.55-.45-1-1-1H4c-.55 
                 0-1 .45-1 1v8c0 .55.45 1 1 1zm0 8h6c.55 0 1-.45 
                 1-1v-4c0-.55-.45-1-1-1H4c-.55 
                 0-1 .45-1 1v4c0 .55.45 1 1 1zm10 
                 0h6c.55 0 1-.45 1-1v-8c0-.55-.45-1-1-1h-6c-.55 
                 0-1 .45-1 1v8c0 .55.45 1 1 1zM13 
                 4v4c0 .55.45 1 1 1h6c.55 0 
                 1-.45 1-1V4c0-.55-.45-1-1-1h-6c-.55 
                 0-1 .45-1 1z"
              />
            </svg>
          </Link>
